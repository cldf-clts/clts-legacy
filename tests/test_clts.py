...
def test_sound_from_name(bipa):
    ...
    assert bipa[
               'from unrounded open front to unrounded close-mid front diphthong'].grapheme == 'ae'
    assert bipa[
               'from voiceless alveolar stop to voiceless velar stop cluster'].grapheme == 'tk'
